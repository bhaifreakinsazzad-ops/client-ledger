...
const ClientProfile = () => {
  ...
  const handleDelete = () => {
    if (
      confirm(`"${client.name}" ক্লায়েন্ট ও তার সব কাজ/লেনদেন মুছে ফেলবেন?`)
    ) {
        ...
        <TabsContent value="works" className="mt-4 space-y-3">
          {works.length === 0 ? (
            <div className="card-surface flex flex-col items-center gap-2 p-10 text-center">
              ...
              <p className="text-sm text-muted-foreground">কোনো কাজ নেই।</p>
            </div>
          ) : (
            works.map((w) => {
