...
const Categories = () => {
  ...
  const handleDelete = (cat: string) => {
    if (
      confirm(
        `"${cat}" ক্যাটাগরি মুছবেন? ক্লায়েন্ট/কাজের ক্যাটাগরি আনসেট হবে না তবে লিস্ট থেকে সরে যাবে।`,
      )
    ) {
      deleteCategory(cat);
  ...
  const handleReset = () => {
    if (
      confirm(
        "সব ডেটা মুছে নমুনা (seed) ডেটায় রিসেট করবেন? এটি undo করা যাবে না।",
      )
    ) {
      resetData();
