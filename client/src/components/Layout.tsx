...
const NAV: NavItem[] = [
  ...
  { to: "/clients", label: "Clients", sublabel: "ক্লায়েন্ট", icon: Users },
  {
    to: "/finance",
    label: "Personal Finance",
    sublabel: "ব্যক্তিগত হিসাব",
    icon: Wallet,
  },
  {
    to: "/accounts",
    label: "Bank Accounts",
    sublabel: "ব্যাংক হিসাব",
    icon: Landmark,
  },
  { to: "/reports", label: "Reports", sublabel: "রিপোর্ট", icon: FileBarChart },
  {
    to: "/settings",
    label: "Categories",
    sublabel: "ক্যাটাগরি",
      ...
      >
        ...
        <div className="border-t border-sidebar-border px-5 py-4">
          <p className="text-[11px] text-sidebar-foreground/50">
            {data.clients.length} clients · {data.works.length} works
          </p>
        </div>
      </aside>
